...
<!-- Add meta tag to force dark theme -->
...
<div class="container">
  <div class="logo">
    <svg width="180" height="100" viewBox="0 0 180 100">
      ...
      <!-- Background shape -->
      <!-- Background shape with wider horizontal size -->
<!-- Background shape with even wider horizontal size -->
<rect x="-35" y="30" width="250" height="45" rx="3" fill="none" stroke="#ffffff" stroke-width="2" />
  ...
  <h1>Welcome Back</h1>
  <div class="whole">
    <span><p>Need an account?</p><p><u><a href="SignUp.jsp">Sign up</a></u></p></span>
  </div>

  <form action="Login" method="post">
    <div class="input-field">
      <input type="text" class="input" placeholder="Username or Email" name="uname" required/>
      <i class='bx bx-user-circle'></i>
    </div>

    <div class="input-field">
      <input type="password" class="input" placeholder="Password" name="upass" required/>
    ...
    <c:if test="${not empty message}">
      <c:choose>
        <c:when test="${message eq 'login successful'}">
