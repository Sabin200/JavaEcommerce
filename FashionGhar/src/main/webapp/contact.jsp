...
<title>Fashion Ghar - Contact Us</title>
<meta name="description" content="Fashion Ghar - Contact Us. Premium monochromatic fashion.">
<meta name="keywords" content="fashion, contact, premium, Fashion Ghar">
<meta name="author" content="Zefex">
...
function validateForm() {
  ...
  if (valid) {
    ...
    document.getElementById("notification").innerHTML = "Thank you, " + name + "! Your message has been sent. We will get back to you soon.";
    ...
    <div class="logo">
      <a href="Home.jsp">
        <svg width="180" height="80" viewBox="0 0 180 80">
          ...
          <!-- Main text -->
          <text x="90" y="45" font-family="Raleway, sans-serif" font-size="28" font-weight="600" text-anchor="middle" fill="url(#logoGradient)">FASHION GHAR</text>
  ...
  <div class="container">
    ...
    <div class="contact-wrapper">
      <div class="contact-form">
        <form id="contactForm" name="contactForm" onsubmit="return validateForm()">
          <div class="form-group">
            <label class="form-label" for="name">Your Name</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Enter your name">
            <small id="nameError" style="color: #ff0000;"></small>
          </div>
          
          <div class="form-group">
            <label class="form-label" for="email">Your Email</label>
            <input type="email" class="form-control" id="email" name="email" placeholder="Enter your email">
            <small id="emailError" style="color: #ff0000;"></small>
          </div>
          ...
          <div class="form-group">
            ...
            <small id="messageError" style="color: #ff0000;"></small>
          </div>
      ...
      <div class="contact-info">
        ...
        <div class="info-item">
          ...
          <p>Mahendrapool, Pokhara, Nepal</p>
        </div>
    ...
    <div class="map-container">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1707.8121844199377!2d83.98533101627214!3d28.216131076684594!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3995944d76693d11%3A0xf1f006d89be13640!2sNew%20Rd%2C%20Pokhara%2033700!5e0!3m2!1sen!2snp!4v1653476468611!5m2!1sen!2snp" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
</section>
...
<div class="footer">
  ...
  <div class="footer-bottom">
    Copyright &copy; Developed By Fashion Ghar
  </div>
</div>
<!--   Footer Bottom end -->
<!--   FOOTER END -->
