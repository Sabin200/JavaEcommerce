...
<title>FashionGhar - Unisex Collection</title>
<meta name="description" content="FashionGhar - Unisex Collection. Premium monochromatic fashion for everyone.">
<meta name="keywords" content="fashion, unisex clothing, premium, FashionGhar">
...
<!-- Banner Section -->
<div class="banner">
  <img src="Images\home4.jpg" alt="Unisex Collection Banner">
  <div class="banner-caption">
    <h1>Unisex Collection</h1>
    <p>Fashion without boundaries - styles designed for everyone</p>
  </div>
</div>
    ...
    <div class="product-boxes">
      ...
      <div class="product-box">
        <div class="product-image">
          <img src="Images/p2.webp" alt="Product 1">
        ...
        <div class="product-info">
          ...
          <div class="product-actions">
            <form action="AddToCart" method="post">
              ...
              <input type="hidden" name="productName" value="Classic White Shirt">
      ...
      <div class="product-box">
        <div class="product-image">
          <img src="Images/p4.webp" alt="Product 2">
      ...
      <div class="product-box">
        <div class="product-image">
          <img src="Images/p5.webp" alt="Product 3">
        </div>
        <div class="product-info">
          <h3>Casual Jacket</h3>
          ...
          <div class="product-actions">
            <form action="AddToCart" method="post">
              ...
              <input type="hidden" name="productName" value="Casual Jacket">
      ...
      <div class="product-box">
        <div class="product-image">
          <img src="Images/slider2.jpg" alt="Product 4">
          <div class="product-badge">New</div>
        </div>
        <div class="product-info">
          <h3>Premium Watch</h3>
          ...
          <div class="product-actions">
            <form action="AddToCart" method="post">
              ...
              <input type="hidden" name="productName" value="Premium Watch">
